...
class StockAnalyzer:
    ...
    def analyze_stock(self, ticker: str) -> Dict:
        ...
        try:
            ...
            result = {
                ...
                'analyst_target': float(info.get('targetMeanPrice', 0)) if info.get('targetMeanPrice') else None,
    ...
    def scan_stocks(self, tickers: List[str], min_score: float = 50):
        ...
        for idx, ticker in enumerate(tickers):
            ...
            try:
                scan_results['progress'] = f"Analyzing {ticker}... ({idx+1}/{total})"
    ...
    <div class="container">
        ...
        <div class="controls">
            <div class="control-group">
                ...
                <div class="score-display">60</div>
            </div>
    ...
    <script>
        ...
        function startScan() {
            ...
            fetch('/start_scan', {
                ...
                body: JSON.stringify({min_score: parseInt(minScore)})
            });
